...
export const iabVaultAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: "_publicGoodsPool", type: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  {
    type: "event",
    name: "PublicGoodsPoolSet",
    inputs: [{ name: "publicGoodsPool", type: "address", indexed: true }],
  },
  {
    type: "event",
    name: "Transfer",
...
export const publicGoodsPoolAbi = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "enum PublicGoodsPool.PoolStatus",
        "name": "",
        "type": "uint8"
      }
    ],
